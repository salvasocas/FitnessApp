...
const Profile = () => {
  const { user, logout, allFoodLogs, allActivityLogs, fetchUser } =
    useAppContext();
      ...
      <div className="profile-content">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg transition-colors duration-200">
                  <div className="size-10 rounded-lg bg-blue-100 dark:bg-blue-900/20 flex items-center justify-center">
                    <Calendar1Icon className="size-4.5 text-blue-600 dark:text-blue-400" />
                  </div>
                  <div>
        ...
        <div className="space-y-4">
          ...
          <Button
            variant="danger"
            onClick={logout}
            className="w-full ring-red-300 hover:ring-2"
          >
